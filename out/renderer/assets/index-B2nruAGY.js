...
function ResourcePanel() {
  ...
  const [imageQuality, setImageQuality] = reactExports.useState("high");
  const [selectedFiles, setSelectedFiles] = reactExports.useState([]);
  const [sendTarget, setSendTarget] = reactExports.useState("broadcast");
  ...
  const handleDrop = reactExports.useCallback((e, type) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2$6, { defaultValue: "send", className: "h-full flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Content$2, { value: "send", className: "flex-1 p-4 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "send-panel space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-type flex gap-2", children: ["text", "image", "file"].map((type) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: `px-4 py-2 rounded text-sm transition-colors ${contentType === type ? "bg-primary text-primary-foreground" : "bg-secondary hover:bg-secondary/80"}`,
            onClick: () => setContentType(type),
            children: type === "text" ? "文字" : type === "image" ? "图片" : "文件"
          },
          type
        )) }),
        contentType === "text" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-editor", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              ref: textInputRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "按 Ctrl+Enter 发送" })
        ] }),
        contentType === "image" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-editor space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "拖拽图片到这里，或点击选择" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "支持 Ctrl+V 粘贴图片" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ref: imageInputRef,
          ...
          selectedFiles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "selected-files grid grid-cols-3 gap-2", children: selectedFiles.map((file, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: file.path,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs truncate", children: file.name })
          ] }, index2)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "compression-options flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm", children: "压缩:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: imageQuality,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "high", children: "高质量" }),
        ...
        contentType === "file" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-editor space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "dropzone border-2 border-dashed border-border rounded p-8 text-center cursor-pointer hover:border-primary/50 transition-colors",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "拖拽文件到这里，或点击选择" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ref: fileInputRef,
          ...
          selectedFiles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "selected-files space-y-1", children: selectedFiles.map((file, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm truncate", children: file.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: formatFileSize(file.size) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "send-target flex gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "广播" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
...
function SoftwarePresetList({ onSelect, multiSelect = false, selectedIds = [] }) {
  ...
  const [formData, setFormData] = reactExports.useState({ name: "", path: "", args: "", workDir: "" });
  reactExports.useEffect(() => {
    loadPresets("software");
  }, [loadPresets]);
  ...
  const handleDelete = async (id2) => {
    if (confirm("确定要删除此预设吗？")) {
      await deletePreset("software", id2);
    }
  };
  ...
  const isSelected = (id2) => selectedIds.includes(id2);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "preset-list-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "软件预设" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
    ...
    softwarePresets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground py-8", children: "暂无软件预设" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: softwarePresets.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `p-3 border rounded-lg cursor-pointer transition-colors ${isSelected(preset.id) ? "border-primary bg-primary/10" : "hover:bg-accent"}`,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground truncate", children: preset.path }),
            preset.args && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
              "参数: ",
              preset.args
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: (e) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Root$1, { open: isDialogOpen, onOpenChange: setIsDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal$1, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { className: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background p-6 rounded-lg shadow-lg z-50 w-[480px] max-h-[80vh] overflow-y-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "程序路径 *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "启动参数" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "工作目录" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Close, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary", children: "取消" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleSave, className: "btn-primary", children: "保存" })
        ] })
      ] })
    ] }) })
  ] });
}
function InputPresetList({ onSelect, multiSelect = false, selectedIds = [] }) {
  const { inputPresets, loadPresets, savePreset, updatePreset, deletePreset } = useConfigStore();
  const [editingPreset, setEditingPreset] = reactExports.useState(null);
  const [isDialogOpen, setIsDialogOpen] = reactExports.useState(false);
  const [formData, setFormData] = reactExports.useState({ name: "", steps: [] });
  reactExports.useEffect(() => {
    loadPresets("input");
  }, [loadPresets]);
  const handleSave = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "preset-list-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "键鼠预设" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
    ...
    inputPresets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground py-8", children: "暂无键鼠预设" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: inputPresets.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `p-3 border rounded-lg cursor-pointer transition-colors ${isSelected(preset.id) ? "border-primary bg-primary/10" : "hover:bg-accent"}`,
        onClick: () => handleSelect(preset),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 mt-1", children: [
              preset.steps.slice(0, 3).map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 bg-secondary rounded", children: getStepTypeLabel(step.type) }, i)),
              preset.steps.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "..." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "步骤" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: formData.steps.map((step, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-2 border rounded", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm w-20", children: getStepTypeLabel(step.type) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
                  ...
                  onChange: (e) => {
                    ...
                    try {
                      newSteps[index2] = { ...step, data: JSON.parse(e.target.value) };
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => {
                    const newSteps = formData.steps.filter((_, i) => i !== index2);
                    setFormData({ ...formData, steps: newSteps });
                  },
...
function SceneList({ onSelect, multiSelect = false, selectedIds = [] }) {
  ...
  const [isDialogOpen, setIsDialogOpen] = reactExports.useState(false);
  const [formData, setFormData] = reactExports.useState({ name: "", description: "", softwarePresetIds: [], inputPresetIds: [] });
  const [dependencyErrors, setDependencyErrors] = reactExports.useState([]);
  reactExports.useEffect(() => {
    loadPresets("scene");
    loadPresets("software");
    loadPresets("input");
  ...
  const isSelected = (id2) => selectedIds.includes(id2);
  const getPresetName = (id2, type) => {
    const presets = type === "software" ? softwarePresets : inputPresets;
    const preset = presets.find((p2) => p2.id === id2);
    return preset?.name || id2;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "preset-list-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "场景编排" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
    ...
    scenes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground py-8", children: "暂无场景" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: scenes.map((scene) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `p-3 border rounded-lg cursor-pointer transition-colors ${isSelected(scene.id) ? "border-primary bg-primary/10" : "hover:bg-accent"}`,
        onClick: () => handleSelect(scene),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: scene.name }),
            scene.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground truncate", children: scene.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 mt-2", children: [
              scene.softwarePresetIds?.map((id2) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 bg-blue-100 text-blue-700 rounded", children: getPresetName(id2, "software") }, id2)),
              scene.inputPresetIds?.map((id2) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 bg-purple-100 text-purple-700 rounded", children: getPresetName(id2, "input") }, id2))
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Root$1, { open: isDialogOpen, onOpenChange: setIsDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal$1, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { className: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background p-6 rounded-lg shadow-lg z-50 w-[520px] max-h-[80vh] overflow-y-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "描述" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-2", children: "软件预设" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 max-h-32 overflow-y-auto border rounded p-2", children: [
              softwarePresets.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 p-1 hover:bg-accent rounded", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "checkbox",
                    ...
                    onChange: (e) => {
                      const ids = e.target.checked ? [...formData.softwarePresetIds, preset.id] : formData.softwarePresetIds.filter((id2) => id2 !== preset.id);
                      setFormData({ ...formData, softwarePresetIds: ids });
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: preset.name })
              ] }, preset.id)),
              softwarePresets.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "暂无软件预设" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-2", children: "键鼠预设" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 max-h-32 overflow-y-auto border rounded p-2", children: [
              inputPresets.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 p-1 hover:bg-accent rounded", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "checkbox",
                    ...
                    onChange: (e) => {
                      const ids = e.target.checked ? [...formData.inputPresetIds, preset.id] : formData.inputPresetIds.filter((id2) => id2 !== preset.id);
              ...
              inputPresets.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "暂无键鼠预设" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 mt-6", children: [
...
function ConfigPanel() {
  ...
  const [exportModules, setExportModules] = reactExports.useState({
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { className: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background p-6 rounded-lg shadow-lg z-50 w-96", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "软件预设" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "键鼠预设" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "场景编排" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Close, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-secondary", children: "取消" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleExport, className: "btn-primary", children: "导出" })
        ] })
      ] })
    ] }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "追加" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "覆盖" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "智能合并" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-2", children: "配置数据 (.lccfg JSON)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                value: importData,
...
function SettingsPanel() {
  ...
  const loadLogs = async () => {
    const mockLogs = [
      { id: "1", timestamp: (/* @__PURE__ */ new Date()).toISOString(), level: "info", message: "Application started" },
      { id: "2", timestamp: (/* @__PURE__ */ new Date()).toISOString(), level: "info", message: "UDP service initialized on port 8888" },
      { id: "3", timestamp: (/* @__PURE__ */ new Date()).toISOString(), level: "info", message: "TCP server started on port 8889" },
      { id: "4", timestamp: (/* @__PURE__ */ new Date()).toISOString(), level: "debug", message: "Device discovery started" }
    ];
    setLogs(mockLogs);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "settings-panel", className: "panel h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2$6, { defaultValue: "device", className: "h-full flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Content$2, { value: "device", className: "flex-1 p-6 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "标签" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Content$2, { value: "network", className: "flex-1 p-6 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "TCP 端口" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "广播间隔 (毫秒)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Content$2, { value: "security", className: "flex-1 p-6 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "允许被控制" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "操作确认" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium mb-1", children: "IP 白名单" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Content$2, { value: "logs", className: "flex-1 p-4 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logs-panel h-full flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3", children: ["all", "run", "audit"].map((type) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: type === "all" ? "全部" : type === "run" ? "运行日志" : "审计日志"
          },
          type
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Root, { className: "flex-1 border rounded", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Viewport$1, { className: "h-full w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: logContainerRef, className: "log-content p-2 font-mono text-xs space-y-1", children: logs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-center py-4", children: "暂无日志" }) : logs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: getLogLevelColor(log.level), children: log.message })
          ] }, log.id)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Scrollbar,
            {
              ...
              orientation: "vertical",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb, { className: "flex-1 bg-border rounded-full relative" })
            }
          )
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: handleSave,
